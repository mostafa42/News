          ...
          <form id="login_form" action="adminAuth" method="POST">
            ...
            <fieldset class="forms_fieldset">
              <div class="forms_field">
                <input type="text" placeholder="{{ __('trans.emailPlaceholder') }}" class="forms_field-input" id="email" name="email" required autofocus />
              </div>
              <div class="forms_field">
                <input type="password" placeholder="{{ __('trans.passwordPlacholder') }}" class="forms_field-input" id="password" name="password" required />
              </div>
            </fieldset>
            <div class="forms_buttons">
              <input type="submit" value="{{ __('trans.loginTitle') }}" class="forms_buttons-action" id="btn_login">
